        ...
        <div className="mt-20 flex flex-wrap items-center justify-center gap-2 sm:gap-3">
            ...
            {currentPage > 1 ? (
                <Link
                    ...
                    className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl border border-gray-100 bg-gray-50/50 flex items-center justify-center text-gray-500 hover:bg-white hover:border-orange-500 hover:text-orange-600 transition-all hover:shadow-xl hover:shadow-orange-500/5"
                >
                ...
                <div className="w-10 h-10 sm:w-12 sm:h-12 rounded-xl sm:rounded-2xl border border-gray-100 flex items-center justify-center text-gray-200 cursor-not-allowed">
                    <svg className="w-4 h-4 sm:w-5 sm:h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={3} d="M15 19l-7-7 7-7" />
                    </svg>
                </div>
